...
Status: proposed implementation, NOT implemented in application code.
Prepared: 2026-09-08. Owner's latest instruction: write the implementation in Markdown only.
